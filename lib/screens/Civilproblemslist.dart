...
//                   SafeArea(
//                       child: Padding(
//                     padding: const EdgeInsets.only(top: 210, right: 120,left: 120),
//                     child: Column(
//                       children: [
//                         Image.asset(
//                           "image/Civil.png",
...
//                           width: 85,
//                         ),SizedBox(width: 10,),
//                         Text("C I V I L",style: TextStyle(fontSize: 20,color: third),)
//                       ],
//                     ),
...
class CivilProblemSelectionPage extends StatefulWidget {
  const CivilProblemSelectionPage({super.key});

  @override
  _ProblemSelectionPageState createState() => _ProblemSelectionPageState();
}

class _ProblemSelectionPageState extends State<CivilProblemSelectionPage> {
  String? _selectedOption;
