...
class ElectricalProblemSelectionPage extends StatefulWidget {
  const ElectricalProblemSelectionPage({super.key});

  @override
  _ProblemSelectionPageState createState() => _ProblemSelectionPageState();
}

class _ProblemSelectionPageState extends State<ElectricalProblemSelectionPage> {
